    ...
    return (
      ...
      >
        ...
        {this.state.showAddReaction ? 
          <div id="addReaction">
              <div id="addReactionHeader" style={{backgroundColor: this.context.accentsColor, color: this.context.textColorMain}}>
                Add Reaction
                <div
                  className="XButton"
              ...
              <div id="addReactionContent">
              {
                this.props.emojis.map((emoji) => 
                  <input 
                    ...
                    style={{backgroundColor: this.context.accentsColor+String(99 * this.isReactionSelected(emoji.dataText))}}
                     />
                )
              }
              </div> 
        ...
        {this.state.showReactions ? 
          <div id="showReactions" >
            <div id="showReactionsHeader" style={{backgroundColor: this.context.accentsColor, color: this.context.textColorMain}}>
              Reactions
              <div
                className="XButton"
            ...
            {
             Object.keys(this.state.reactions).map((key) => <p style={{color: this.context.textColorMain}}>{key + "" + this.state.reactions[key]}</p>)
             }
             </div>
          </div>
          : null}
